...
[2025-05-25] バージョン:2.7.0

・[機能追加]　試験機能：そらちゃんの一部ポストを試験的に埋め込みました。

　ページ下部に、告知ポストと最初のポストを表示しています。
　告知の助けになれば。

.[デザイン]ボタンの大きさを調整しました。少しタップしやすくなったかな？

　フローティングぬんぬんボタン実装で、ページ縦の長さを無理に抑えなくていいのでは？と思ったのでやってみる。
