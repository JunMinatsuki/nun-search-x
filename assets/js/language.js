const languageData = {
  ...
  'ja': {
    ...
    'header-caption': 'ヘッダーイラスト提供：もこもこも好きDS',
    ...
    'heading-soradule': 'そらじゅーる',
    'heading-sorachaninfo': 'そらちゃんインフォ非公式カレンダー',
    'text-sorachaninfo': '提供：【非公式】そらちゃんインフォ🐻💿',
    ...
    'tokino-timer-text-sorapa':'そらぱ（ワンマンライブ）まで',
  ...
  'en': {
    ...
    'header-caption': 'Header illustration provided by: もこもこも好きDS',
    'label-language-selector': 'Language: ',
    ...
    'text-footer03': '.',
    'heading-soradule': 'Soradule',
    'heading-sorachaninfo': 'Sora-chan Info Unofficial Carendar',
    'text-sorachaninfo': 'Provided by:【Unofficial】Sora-chan Info',
    ...
    'tokino-timer-text-sorapa':'Remaining until Sorapa(Solo concert)',
  ...
  'zh-CN': {
    ...
    'header-caption': '页首插图提供：もこもこも好きDS',
    'label-language-selector': 'Language: ',
    ...
    'text-media-only': '只搜索媒体推文',
		'text-option-filter': '筛选',
		'text-option-nofilter': '不筛选图像、视频或空间',
		'text-space-only': '只搜索空间推文',
		'text-notes-space-only': '空间筛选在 YRT 中已禁用',
    ...
    'tokino-timer-text-sorapa':'剩余至Sorapa(个人演唱会)',
  ...
  'zh-TW': {
    ...
    'header-caption': '頁首插圖提供：もこもこも好きDS',
    'label-language-selector': 'Language: ',
    ...
    'text-media-only': '只搜尋媒體推文',
		'text-option-filter': '篩選',
		'text-option-nofilter': '不篩選圖像、影片或空間',
		'text-space-only': '只搜尋空間推文',
		'text-notes-space-only': '空間篩選在 YRT 中已禁用',
    ...
    'tokino-timer-text-sorapa':'剩餘至Sorapa(個人演唱會)',
  ...
  'zh-HK': {
    ...
    'text-media-only': '只搜尋媒體推文',
		'text-option-filter': '過濾',
		'text-option-nofilter': '唔篩選圖像、影片或空間',
		'text-space-only': '只搜尋空間嘅推文',
		'text-notes-space-only': '喺 YRT 入面，空間過濾係禁用嘅',
    'heading-date': '1.搜尋日期範圍',
    'date-text-notes': '※可點選方框啟用/停用日期範圍',
    'text-set-time': '設定時間 JST',
    'text-date-01': '開始日期',
  ...
  'ko': {
    ...
    'header-caption': '헤더 일러스트 제공 : もこもこも好きDS 님',
    'label-language-selector': 'Language: ',
    ...
    'text-media-only': '미디어 게시물만 검색',
		'text-option-filter': '필터',
		'text-option-nofilter': '이미지, 동영상 또는 스페이스를 필터링하지 않습니다',
		'text-space-only': '스페이스 게시물만 검색합니다',
		'text-notes-space-only': 'YRT에서는 스페이스 필터링이 비활성화됩니다.',
    ...
    'tokino-timer-text-sorapa':'소라파(솔로 콘서트)까지 남은 시간',
  ...
  'id': {
    ...
    'header-caption': 'Ilustrasi tajuk disediakan oleh: もこもこも好きDS',
    'label-language-selector': 'Language: ',
    ...
    'text-media-only': 'Cari hanya postingan media',
		'text-option-filter': 'Filter',
		'text-option-nofilter': 'Jangan memfilter gambar, video, atau Ruang',
		'text-space-only': 'Cari postingan Ruang saja',
		'text-notes-space-only': 'Pemfilteran Ruang dinonaktifkan di YRT.',
    ...
    'tokino-timer-text-sorapa':'Sorapa(Konser solo) ulang tahun',
