const languageData = {
  ...
  'ja': {
    ...
    'button-text-news-01': 'hololive production OFFICIAL SHOP',
  ...
  'zh-CN': {
    ...
    'label-language-selector': 'Language: ',
    'text-description': '“Nun Search”是用于搜索与Hololive旗下Vtuber"时乃空"相关的 X post 的工具。您可以轻松设置搜索日期范围、常用标签等。它可能会让你最喜欢的偶像活动和自我搜索变得更容易。',
    'heading-news': '🌟 Tokino News 🌟',
    'heading-news-01': '🐻时乃空生日2025周边商品发售💿',
    'text-news-01': '全套均附有签名',
    'button-text-news-01': 'hololive production OFFICIAL SHOP',
    'heading-option': '选项',
  ...
  'zh-TW': {
    ...
    'label-language-selector': 'Language: ',
    'text-description': '"Nun Search"是Hololive旗下Vtuber"時乃空"的 X post 工具。可以確認搜尋的日期時間、常用標記等，更輕鬆地搜尋最開心的偶像活動。',
    'heading-news': '🌟 Tokino News 🌟',
    'heading-news-01': '🐻時乃空生日2025週邊商品發售💿',
    'text-news-01': '全套均附有簽名',
    'button-text-news-01': 'hololive production OFFICIAL SHOP',
    'heading-option': '選項',
  ...
  'zh-HK': {
    ...
    'header-caption': '頁首插圖提供：もふもふ大好きDS',
    'label-language-selector': 'Language: ',
    'text-description': '"Nun搜尋"係一個喺 Hololive 旗下嘅 Vtuber"時乃空"嘅 X post 嘅工具，你可以睇返你搜尋嘅日期同時間，常用嘅標記等等，令你更容易搵到你搵到嘅最歡樂嘅偶像活動。',
    'heading-news': '🌟 Tokino News 🌟',
    'heading-news-01': '🐻時乃空生日2025周邊商品發售💿',
    'text-news-01': '全套均附有簽名',
    'button-text-news-01': 'hololive production OFFICIAL SHOP',
    'heading-option': '選項',
  ...
  'ko': {
    ...
    'label-language-selector': 'Language: ',
    'text-description': '"눈서치" 는 홀로 라이브 소속의 Vtuber "토키노 소라" 에 관한 X포스트의 검색 툴입니다.검색 날짜와 시간의 범위와 자주 사용되는 해시 태그 등을 쉽게 설정할 수 있습니다.추격활이나 에고사가 편해질지도.',
    'heading-news': '🌟 Tokino News 🌟',
    'heading-news-01': '🐻토키 소라 생일 기념 2025 상품 판매 중💿',
    'text-news-01': '풀 세트에서는 친필 사인이 온다',
    'button-text-news-01': 'hololive production OFFICIAL SHOP',
    'heading-option': '옵션',
  ...
  'id': {
    ...
    'heading-news': '🌟 Tokino News 🌟',
    'heading-news-01': '🐻Barang peringatan ulang tahun Tokino Sora 2025 sedang obral💿',
    'text-news-01': 'Set lengkap dilengkapi dengan tanda tangan',
    'button-text-news-01': 'hololive production OFFICIAL SHOP',
    'heading-option': 'Opsi',
